  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative">
        ...
        <section
          ref={heroRef}
          className="relative w-full h-[82vh] pt-24 text-white overflow-hidden"
          style={{ zIndex: 1 }}
        >
          {/* Background Video */}
          <video
          ...
          <div className="max-w-7xl mx-auto px-6 py-8 relative z-10 h-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full">
              <div>
                <h1
                  className="text-4xl md:text-5xl font-bold mb-6 text-[#69226F]"
                  style={{ fontFamily: '"Aardvark Cafe", Georgia, serif' }}
                >
                  The World's Largest Skill Assessment Library
                </h1>
                <p
                  className="mb-8 max-w-xl text-[23.5px] text-black"
        ...
        <div
          ref={callCenterRef}
          className="absolute w-full h-[54vh]"
          style={{
            top: "56vh",
            zIndex: 2,
          }}
